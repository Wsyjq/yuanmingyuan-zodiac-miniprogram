...
const NOVEL_PARAGRAPHS = [
  { text: '一路走过来，谐奇趣、黄花阵、方外观、海晏堂、大水法各自留下过一张图样。它们一直是屏幕上的残片，并不是开场就塞进袋子、可以提前拼上的纸片。' },
  { text: '把它们摊在同一屏上，边缘对得上。五张来自不同地点的残片，拼成一幅铜版画风格的长卷。谐奇趣、黄花阵、方外观、海晏堂、大水法都在上面。' },
  { text: '可画面中央偏偏空着一块。那块空白没有图案，只印着四个很浅的字：此处待绘。' },
  { text: '原来这些图样并不是为了找到一张早就藏好的「第二十一图」。这幅画根本还没有完成。档案里的人只留下了四周，把中间的位置空了出来。' },
  { text: '乾隆时期留下的二十幅《西洋楼铜版图》，记录的是西洋楼建成时的样子。但那只是它当时的样子。后来发生的事情，并不在那二十幅画中。' },
  { text: '所以，我留下了“第二十一图”这个传闻。不是为了让后来的人找到一幅藏起来的旧画，而是想让来到这里的人，重新走一遍西洋楼，把自己真正看到的东西记录下来。', highlight: true },
  { text: '而最后缺少的那一部分，就是今天来到这里的人。剩下的，是你的名字，和今天的日期。' }
]
