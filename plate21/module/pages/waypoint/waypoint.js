...
// 散页红线（V2.1）：不设谜题判定、不要求输入、不做裁判、不出日期卡；
...
const SITES = {
    ...
    beats: [
      {
        ...
        lines: [
          ...
          '水要被提到那个高度。一天十二个时辰，提上去，喷下来，再提上去，中间不能停。'
        ]
      },
      {
        kicker: '夹页 · 三页纸与一处空栏',
  ...
  guanshuifa: {
    ...
    intro: '大水法对面，坐南朝北一座平台，上面设过宝座——观水法。皇帝当年就在这儿看喷泉。',
    beats: [
      {
        kicker: '现场 · 看',
        lines: [
          '喷泉在南，宝座在北，中间隔着水。',
          '站到平台这儿往南看大水法——谁坐着看，谁对着谁，位置本身就说明了一半。',
          '不出题，无道具。看完就走。'
        ]
      },
      {
