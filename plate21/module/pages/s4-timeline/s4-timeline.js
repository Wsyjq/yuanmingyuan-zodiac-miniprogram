...
// 站名叙事（V2.1 可用稿 §第五站，「你」视角；先对年，再读信）
const PARAGRAPHS = [
...
// 站尾收束（V2.1：对完年读信；四件东西卡自排一列不评分；开放问不给选项不投票）
const MONOLOGUE_PARAGRAPHS = [
  '排完才对上：信是一八六一年写的，写的人从没来过中国；像是二〇一〇年才立的。年对齐了，再读信。',
  '把信抽出来，站在像底下读完。读完愣了一下。这封信本来就不是写给你的，你还是把它读完了。',
  '他没来过中国，没见过这座园子完整的样子，更没见过这片废墟。听别人说，看别人画，自己在遥远的地方把它想象出来，然后真的为它生了好大一通气。你可以跟着愣一下，也可以不同意。反正信读完了。',
  '但它是一封信，不是一张画。他连园子都没来过，也没站在你一路站过的这些位置上。'
]

const RELIC_CARDS = [
  { no: '一', text: '观水法石屏风。曾搬进城里私园，1977 年运回原址。圆明园第一件完整回归的流失文物。' },
  { no: '二', text: '翻尾石鱼。谐奇趣南池那条，现在北京大学未名湖西侧，还在水里。' },
