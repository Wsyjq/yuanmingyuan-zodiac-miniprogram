...
## BGM 风格对表剧情（2026-09-12 重做 5 首）

用户反馈初版偏西式、与剧情不贴 → 按 V2.2 剧情逐站重做（提示词 `tools/bgm_prompts_v22.json`，
本地 ComfyUI+MiniMax-Music-3，种子 20260912-16，短曲经 acrossfade 自拼延长至 60-80s）：

| 曲目 | 新方向 |
|---|---|
| bgm-01 序章/入口 | 中式书房：古琴对箫、五声、纸墨沙沙、无西方乐器 |
| bgm-02 黄花阵 | 中秋宫灯夜：笛子领奏+琵琶扬琴、宫廷轻快五声 |
| bgm-03 方外观 | 殿外静候：独箫大留白+古琴泛音如远钟 |
| bgm-04 海晏堂 | 水力钟：编钟磬报时+古筝流水+一丝巴洛克大提琴低音（中西合璧=剧情） |
| bgm-06 终章 | 拼合残片：钢琴/古筝单音互相靠近但不合流，收在未解决乐句（此处待绘） |

保留不动：bgm-07x/07/08 谐奇趣双声道（乾隆朝中西并奏=剧情）、bgm-09 养雀笼（箫）、
bgm-10 蓄水楼（机械底音）、bgm-11 线法画（画中即西洋街）、bgm-12 雨果（1861 法式弦乐）、
bgm-13 回响（晨光极简）；大水法零配乐=设计。
旧西式版本备份于 `bgm/backup-western-20260912/`（wt-v22 与主库各一份）。
